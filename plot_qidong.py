...
z5 = []
x_time4 = []
with open('data/启动/speed400rpm.txt', 'r') as f, open('data/启动/speed600rpm.txt','r') as f2, \
        open('data/启动/speed800rpm.txt', 'r') as f3:
...
# plt.set_ylim=(0,500)
# plt.grid(True)
p2.plot(Y1, Z1,  linestyle='--', color='#000080', linewidth=2.5, label=r'$n_r=400rpm$')
p2.plot(Y2, Z2, color='#556B2F', linewidth=2.5,label=r'$n_r=600rpm$')
p2.plot(Y3, Z3, color='#B22222',linestyle='-.', linewidth=2.5,label=r'$n_r=800rpm$')
