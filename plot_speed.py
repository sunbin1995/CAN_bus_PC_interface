...
z5 = []
x_time4 = []
with open('data/b0/speed_0.5b0.txt', 'r') as f, open('data/b0/speed_b0.txt','r') as f2, \
        open('data/b0/speed_1.5b0.txt', 'r') as f3:
...
# plt.set_ylim=(0,500)
# plt.grid(True)
p2.plot(Y1, Z1,  linestyle='--', color='#000080', linewidth=2.5, label=r'$b_0= 0.5b$')
p2.plot(Y2, Z2, color='#556B2F', linewidth=2.5,label=r'$b_0= b$')
p2.plot(Y3, Z3, color='#B22222',linestyle='-.', linewidth=2.5,label=r'$b_0= 1.5b$')
